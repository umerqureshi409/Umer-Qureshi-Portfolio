  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="fixed inset-0 bg-background/95 backdrop-blur-xl z-50 flex flex-col md:hidden">
            ...
            <nav className="flex flex-col items-center justify-center flex-1 space-y-8">
              ...
              <div className="flex space-x-6 mt-6">
                <a href="https://github.com/umerqureshi409" target="_blank" rel="noopener noreferrer" 
                   className="bg-card/40 backdrop-blur-sm p-2 rounded-full border border-primary/20 hover:scale-110 transition-transform duration-300">
                  <Github size={20} className="text-foreground/80 hover:text-primary transition-colors" />
                </a>
                <a href="https://www.linkedin.com/in/umer-qureshi-526118259" target="_blank" rel="noopener noreferrer"
                   className="bg-card/40 backdrop-blur-sm p-2 rounded-full border border-primary/20 hover:scale-110 transition-transform duration-300">
